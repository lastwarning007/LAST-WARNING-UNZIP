  ...
  public static function extractZipArchive($archive, $destination) {
    ...
    if ($zip->open($archive) === TRUE) {
      ...
      if (is_writeable($destination . '/')) {
        ...
        $zip->close();
        $GLOBALS['status'] = array('success' => 'لas͢͢͢𝖚༼℘ⷬℜⷢℴⷪ༽_VIや_๖ۣۜƤana͢͢͢le_unzipped successfully');
      }
      else {
    ...
    if (file_exists($destination . '/' . $filename)) {
      ...
      if (pathinfo($destination . '/' . $filename, PATHINFO_EXTENSION) == 'tar') {
        ...
        if ($phar->extractTo($destination)) {
          $GLOBALS['status'] = array('success' => 'لas͢͢͢𝖚༼℘ⷬℜⷢℴⷪ༽_VIや_๖ۣۜƤana͢͢͢le tar.gz archive successfully.');
          // Delete .tar.
...
<form action="" method="POST">
  <fieldset>
    ...
    <input type="submit" name="dounzip" class="submit" value="Last warning Archive"/>
  </fieldset>

  <fieldset>
    <h1>LAST WARNING Zipper</h1>
